...
# ============================================================
# ٠) النافذة اللي بتظهر على الشاشة
# ============================================================
edit(
    'no print status dialog',
    """        $pd.DocumentName = 'IFixTeam Label';""",
    """        $pd.DocumentName = 'IFixTeam Label';
        # ⚠️ من غير السطر ده .NET بيستخدم PrintControllerWithStatusDialog
        #    وبيفتح نافذة "Printing - Page 1 of IFixTeam Label" على
        #    الشاشة مع كل ليبل.
        #    ومش إزعاج بس: الوكيل شغال مخفي عن طريق run-agent-hidden.vbs
        #    من غير نافذة، فالحوار بيفضل معلّق و $pd.Print() مابيرجعش،
        #    والأمر بيموت على مهلة الـ 20 ثانية. ده بيخلي الطباعة
        #    السحابية من الموبايل تفشل حتى والوكيل شغال تمام.
        #    StandardPrintController بيطبع من غير أي واجهة خالص.
